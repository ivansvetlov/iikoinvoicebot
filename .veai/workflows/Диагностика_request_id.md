...
## Вход
Можно вставлять как удобно человеку:
- полный request_id (например `20260308_000736_800_6106711925`)
- короткий код из сообщения бота (например `000736_800`)
- или даже строку целиком: `Код заявки: 000736_800`
