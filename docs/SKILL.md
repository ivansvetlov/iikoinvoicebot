...
**The rule is simple: nothing goes into docs/DEBUG.md until you've proven it works.**
...
1. **Verify before documenting**
    ...
    - Every claim in docs/DEBUG.md must be backed by your own test.
...
**Do not write to docs/DEBUG.md yet.** This is just reconnaissance.
...
### Phase 3: Document verified methods in docs/DEBUG.md

Only after completing Phase 2 verification for a runtime, add it to docs/DEBUG.md.
...
**Before writing "verified" in docs/DEBUG.md, ask yourself:**
...
Your work on this skill is complete when docs/DEBUG.md contains:
...
-   New runtime? Add it to docs/DEBUG.md after verification
-   Method stopped working? Update docs/DEBUG.md
-   Found a better approach? Test it, then update

docs/DEBUG.md is the source of truth for autonomous work. Keep it accurate.
