...
- [ ] Создать ветку под канал MAX (например, `feature/channel-max`)
- [ ] Создать ветку под интеграцию МойСклад (например, `feature/integration-moysklad`)
- [ ] Создать ветку под интеграцию 1С (например, `feature/integration-1c`)
